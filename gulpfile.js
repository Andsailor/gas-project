...
gulp.task('php', function() {
    return gulp.src('./src/question.php')
           .pipe(gulp.dest(dest + '/'));
});
...
gulp.task('dev', gulp.series('clear', gulp.parallel('html', 'scss', 'images', 'javascript', 'php'), function() {
    browserSync.init({
        server: {
...
gulp.task('build', gulp.series('clear', gulp.parallel('html', 'scss', 'images', 'javascript', 'php')));